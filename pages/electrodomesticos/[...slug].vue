...
const { data: article } = await useAsyncData(`electrodomesticos-article-${route.path}`, () => {
...
if (article.value) {
  ...
  useSeo({
    title: `${subcategoryName.value} - Electrodomésticos | QueDure.es`,
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16">
      <div class="container-wide">
        <nav class="text-sm mb-4">
          ...
          <NuxtLink to="/electrodomesticos" class="text-primary-200 hover:text-white">Electrodomésticos</NuxtLink>
          <span class="mx-2 text-primary-300">/</span>
